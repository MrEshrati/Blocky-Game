...
public class FactoryBlock extends AbstractBlock {
    @Override
    public int getImageResourceId() {
        return R.drawable.factory_block;
    }

    @Override
    public int getNameResourceId() {
        return R.string.block_factory;
    }
        ...
        this.effects =  new HashMap<AbstractMetric, Float>(){
            {
                ...
                put(engine.getMetrics().get(MetricTypes.HEALTH_METRIC), -1f);
            }
        };
    }
}
